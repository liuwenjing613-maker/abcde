#!/usr/bin/env python3
"""Trial 20: LDAM Loss for imbalanced anxiety classification.

Usage:
    PYTHONPATH=src python scripts/exp_ldam.py \
        --dataset-path datasets \
        --output-dir artifacts/exp/ldam \
        --device cuda
"""
...
from ccac.experiments.ldam_loss import LDAMConfig, train_ldam


def main():
    p = argparse.ArgumentParser(description="Trial 20: LDAM Loss")
    p.add_argument("--dataset-path", type=str, default="datasets")
    p.add_argument("--output-dir", type=str, default="artifacts/exp/ldam")
    ...
    p.add_argument("--drw-epoch", type=int, default=50,
                   help="Epoch after which to apply class re-weighting (0=always, >80=never)")
