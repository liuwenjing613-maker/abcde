...
Current project status and experiment notes are organized under `docs/`:

- `docs/current_project_situation.md`: current valid direction and next steps.
- `docs/metric_analysis.md`: why Macro-F1 alone is misleading for this project.
- `docs/experiments/`: valid no-DASS experiments and public submission logs.
- `docs/archive/`: older DASS-heavy notes kept for historical reference.
